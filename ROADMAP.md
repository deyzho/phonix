...
- ✅ **`@phonixsdk/mobile`** — React Native / Expo SDK with `usePhonix`, `useMessages`, `useSend` hooks; `PhonixProvider` context; iOS Keychain / Android Keystore via `expo-secure-store`; AppState lifecycle management
